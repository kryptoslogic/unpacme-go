...
// DeepmatchEntityAllOf struct for DeepmatchEntityAllOf
type DeepmatchEntityAllOf struct {
...
func (o DeepmatchEntityAllOf) MarshalJSON() ([]byte, error) {
...
type NullableDeepmatchEntityAllOf struct {
	value *DeepmatchEntityAllOf
	isSet bool
}

func (v NullableDeepmatchEntityAllOf) Get() *DeepmatchEntityAllOf {
	return v.value
}

func (v *NullableDeepmatchEntityAllOf) Set(val *DeepmatchEntityAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableDeepmatchEntityAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableDeepmatchEntityAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeepmatchEntityAllOf(val *DeepmatchEntityAllOf) *NullableDeepmatchEntityAllOf {
	return &NullableDeepmatchEntityAllOf{value: val, isSet: true}
}

func (v NullableDeepmatchEntityAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeepmatchEntityAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
