...
// UnpackStatusAllOf struct for UnpackStatusAllOf
type UnpackStatusAllOf struct {
...
func (o UnpackStatusAllOf) MarshalJSON() ([]byte, error) {
...
type NullableUnpackStatusAllOf struct {
	value *UnpackStatusAllOf
	isSet bool
}

func (v NullableUnpackStatusAllOf) Get() *UnpackStatusAllOf {
	return v.value
}

func (v *NullableUnpackStatusAllOf) Set(val *UnpackStatusAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableUnpackStatusAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableUnpackStatusAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnpackStatusAllOf(val *UnpackStatusAllOf) *NullableUnpackStatusAllOf {
	return &NullableUnpackStatusAllOf{value: val, isSet: true}
}

func (v NullableUnpackStatusAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnpackStatusAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
