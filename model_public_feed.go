...
type PublicFeed struct {
	Results *[]FeedEntity `json:"results,omitempty"`
}
...
// SetResults gets a reference to the given []FeedEntity and assigns it to the Results field.
func (o *PublicFeed) SetResults(v []FeedEntity) {
	o.Results = &v
}

func (o PublicFeed) MarshalJSON() ([]byte, error) {
...
type NullablePublicFeed struct {
	value *PublicFeed
	isSet bool
}

func (v NullablePublicFeed) Get() *PublicFeed {
	return v.value
}

func (v *NullablePublicFeed) Set(val *PublicFeed) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicFeed) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicFeed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicFeed(val *PublicFeed) *NullablePublicFeed {
	return &NullablePublicFeed{value: val, isSet: true}
}

func (v NullablePublicFeed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicFeed) UnmarshalJSON(src []byte) error {
	v.isSet = true
