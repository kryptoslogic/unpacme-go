...
var (
	...
	octetCheck = regexp.MustCompile(`(?i:(?:application|text)/octet-stream)`)
)

// APIClient manages communication with the UnpacMe API v1.0.0
...
type APIClient struct {
	...
	UnpackingApi *UnpackingApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.UnpackingApi = (*UnpackingApiService)(&c.common)
...
func (c *APIClient) decode(v interface{}, b []byte, contentType string) (err error) {
	...
	if octetCheck.MatchString(contentType) {
		// @davido: added as hacky support for application/octet-stream
		return nil
	}
