...
// UnpackResultsAllOf struct for UnpackResultsAllOf
type UnpackResultsAllOf struct {
...
func (o UnpackResultsAllOf) MarshalJSON() ([]byte, error) {
...
type NullableUnpackResultsAllOf struct {
	value *UnpackResultsAllOf
	isSet bool
}

func (v NullableUnpackResultsAllOf) Get() *UnpackResultsAllOf {
	return v.value
}

func (v *NullableUnpackResultsAllOf) Set(val *UnpackResultsAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableUnpackResultsAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableUnpackResultsAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnpackResultsAllOf(val *UnpackResultsAllOf) *NullableUnpackResultsAllOf {
	return &NullableUnpackResultsAllOf{value: val, isSet: true}
}

func (v NullableUnpackResultsAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnpackResultsAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
