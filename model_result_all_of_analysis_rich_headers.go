...
// ResultAllOfAnalysisRichHeaders struct for ResultAllOfAnalysisRichHeaders
type ResultAllOfAnalysisRichHeaders struct {
	// Rich header checksum
	Checksum *string `json:"Checksum,omitempty"`
	Entries *[]RichHeader `json:"Entries,omitempty"`
}
...
func NewResultAllOfAnalysisRichHeaders() *ResultAllOfAnalysisRichHeaders {
	this := ResultAllOfAnalysisRichHeaders{}
	return &this
}
...
// SetEntries gets a reference to the given []RichHeader and assigns it to the Entries field.
func (o *ResultAllOfAnalysisRichHeaders) SetEntries(v []RichHeader) {
	o.Entries = &v
}

func (o ResultAllOfAnalysisRichHeaders) MarshalJSON() ([]byte, error) {
...
type NullableResultAllOfAnalysisRichHeaders struct {
	value *ResultAllOfAnalysisRichHeaders
	isSet bool
}

func (v NullableResultAllOfAnalysisRichHeaders) Get() *ResultAllOfAnalysisRichHeaders {
	return v.value
}

func (v *NullableResultAllOfAnalysisRichHeaders) Set(val *ResultAllOfAnalysisRichHeaders) {
	v.value = val
	v.isSet = true
}

func (v NullableResultAllOfAnalysisRichHeaders) IsSet() bool {
	return v.isSet
}

func (v *NullableResultAllOfAnalysisRichHeaders) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResultAllOfAnalysisRichHeaders(val *ResultAllOfAnalysisRichHeaders) *NullableResultAllOfAnalysisRichHeaders {
	return &NullableResultAllOfAnalysisRichHeaders{value: val, isSet: true}
}

func (v NullableResultAllOfAnalysisRichHeaders) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResultAllOfAnalysisRichHeaders) UnmarshalJSON(src []byte) error {
	v.isSet = true
